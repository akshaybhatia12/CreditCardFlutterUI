...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  var appColors = [Color.fromRGBO(231, 129, 109, 1.0),
  Color.fromRGBO(99, 138, 223, 1.0), Color.fromRGBO(111, 194, 173, 1.0)
  ];
  var cardIndex = 0;
  late ScrollController scrollController;
  var currentColor = Color.fromRGBO(231, 129, 109, 1.0);
  var cardList = [CardItemModel("Personal", Icons.account_circle,9, 0.83),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Hello Akshay", style: TextStyle(
                      fontSize: 30.0 , color: Colors.white, fontWeight: FontWeight.w400),),
                    ),
                    Text("It Feels Good Here", style: TextStyle(color: Colors.white),),
                    Text("You Have Total 3 Tasks Now !", style: TextStyle(color: Colors.white),),
                  ],
                ),
              ),
            ),
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("TODAY : JUL 20, 2021" , style: TextStyle(color: Colors.white),),
                ),
                Container(
                  height: 350.0,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Icon(
                                            cardList[position].icon, color: appColors[position],
                                          ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: EdgeInsets.symmetric(horizontal: 8.0,vertical: 4.0),
                                            child: Text(
                                              "${cardList[position].taskCompletion}"
                                            ),
                                          ),
                                        ],
                                      ),
